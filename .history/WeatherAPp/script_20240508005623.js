...
const showWeather = async (city) => {
    ...
    <div class="weatherImg">
                    ...
                    <div class="details">
                      <span><img src="/assets/images/weather/humidity.png" alt=""> Humidity ${data.main.humidity}%</span>
                      <span><img src="/assets/images/weather/wind.png" alt=""> Wind Speed ${data.wind.speed} km/h</span>
                      <span><img src="/assets/images/weather/pressure.png" alt=""> Pressure ${data.main.pressure} mb</span>
                      <span><img src="/assets/images/weather/max.png" alt=""> <img src="/assets/images/weather/temp.png" alt=""> Max.Temp ${data.main.temp_max}</span>
                      <span><img src="/assets/images/weather/min.png" alt=""> <img src="/assets/images/weather/temp.png" alt=""> Min.Temp ${data.main.temp_min}</span>
                    </div>
    `
